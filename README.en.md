...
**[Download the latest release (Windows)](https://github.com/sailorsinbad14/hengji/releases/latest)** — double-click `Hengji_0.5.1_x64-setup.exe`, install, and go. No dev environment required; **your data lives 100% on your machine, never uploaded**.

> Current version v0.5.1, Windows x64 only, unsigned. On the SmartScreen "unknown publisher" prompt, choose **"More info → Run anyway"**. To build from source or contribute, see the [Developer guide](docs/en/development.md).
